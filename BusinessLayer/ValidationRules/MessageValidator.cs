...
namespace BusinessLayer.ValidationRules
{
    public class MessageValidator : AbstractValidator<Message>
    {
        public MessageValidator()
        {
            ...
            RuleFor(x => x.MesaageContent).NotEmpty().WithMessage("Mesajı boş geçemezsiniz.");
            ...
            RuleFor(x => x.MesaageContent).MinimumLength(10).WithMessage(" Mesaj içeriği en az 10 karakter olmalı");
        }
    }
}
